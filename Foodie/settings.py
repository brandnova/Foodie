...
SECRET_KEY = 'django-insecure-=$d3s3(m=g4&8w*s&5zx$6bjy5sc_k6rofp*1vudxnt49^r)oy'
...
# Add an email address for site admins to receive order notifications
ADMIN_EMAIL = 'brandnova89@gmail.com'
